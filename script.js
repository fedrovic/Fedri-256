...
if (toggleBtn) { toggleBtn.addEventListener('click', () => { body.classList.toggle('dark-mode'); const icon = toggleBtn; if (body.classList.contains('dark-mode')) { icon.classList.remove('fa-moon'); icon.classList.add('fa-sun'); } else { icon.classList.remove('fa-sun'); icon.classList.add('fa-moon'); } }); }
...
// Google Analytics (already added in HTML)

// WhatsApp Button - Optional Future Enhancement Placeholder // You can add functionality if needed later.
